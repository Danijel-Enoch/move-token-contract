...
module sui_coin::cubic {
    ...
    /// registered once.
    fun init(witness: CUBIC, ctx: &mut TxContext) {
        // Get a treasury cap for the coin and give it to the transaction sender
        let (treasury_cap, metadata) = coin::create_currency<CUBIC>(witness, 9, b"CUB", b"CUBICn", b"Cubic Coin", option::some(url::new_unsafe_from_bytes(b"https://static-file.cubicgames.xyz/cubic_icon.png")), ctx);
